...
{
;_Bool __cs_tmp_if_cond_0; __cs_tmp_if_cond_0 = ((*head).aba == (*orig).aba); 
...
;_Bool __cs_tmp_if_cond_1; __cs_tmp_if_cond_1 = ((*lstack).node_buffer == 0); 
...
;_Bool __cs_tmp_if_cond_2; __cs_tmp_if_cond_2 = (orig.node == 0); 
...
;_Bool __cs_tmp_if_cond_3; __cs_tmp_if_cond_3 = (node == 0); 
...
;_Bool __cs_tmp_if_cond_4; __cs_tmp_if_cond_4 = (node == 0); 
...
int i2;
i2 = 0;
;_Bool __cs_tmp_if_cond_5; __cs_tmp_if_cond_5 = ((_agg_e1 >= 1) && (_agg_e1 <= 10)); 
        if (__cs_tmp_if_cond_5)
        {
_agg_t1[i1] = _agg_e1;
i1++;
        }
;_Bool __cs_tmp_if_cond_6; __cs_tmp_if_cond_6 = ((_agg_e1 >= 11) && (_agg_e1 <= 20)); 
        if (__cs_tmp_if_cond_6)
        {
_agg_t2[i2] = _agg_e1;
i2++;
        }
;_Bool __cs_tmp_if_cond_7; __cs_tmp_if_cond_7 = ((_agg_e2 >= 1) && (_agg_e2 <= 10)); 
        if (__cs_tmp_if_cond_7)
        {
_agg_t1[i1] = _agg_e2;
i1++;
        }
;_Bool __cs_tmp_if_cond_8; __cs_tmp_if_cond_8 = ((_agg_e2 >= 11) && (_agg_e2 <= 20)); 
